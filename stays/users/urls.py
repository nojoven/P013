...
urlpatterns = [
    ...
    path(
        "login",
        views.AccountLoginView.as_view(template_name="signin.html"),
        name="login",
    ),
    path(
        "logout",
        authentication_views.LogoutView.as_view(template_name="signout.html"),
        name="logout",
    ),
    ...
    path(
        "account/<slug:slug>/stays", views.ProfileStaysListView.as_view(), name="stays"
    ),
    path("account/<slug:slug>/publish", views.PublishView.as_view(), name="publish"),
    path(
        "account/<slug:slug>/settings",
    ...
    path(
        "profile/<slug:slug>/public", views.ProfileDetailView.as_view(), name="profile"
    ),
    path(
        "profile/<slug:slug>/followtoggle", views.follow_profile, name="follow_unfollow"
    ),
    path(
