...
class TestFetchAirWeatherTime:
    ...
    async def test_fetch_air_weather_time(self, mock_fetch_additional_data):
        ...
        json_file_path_weather = os.path.join(base_dir, 'utils', 'ninjas_api_weather_paris_response.json')
        json_file_path_world_time = os.path.join(base_dir, 'utils', 'ninjas_api_time_paris_response.json')
        ...
        mock_fetch_additional_data.return_value = mock_response_air_quality, mock_response_weather, mock_response_world_time
