...
class ServeFilesTest(TestCase):
    ...
    def test_serve_publication_picture(self):
        ...
        picture_response = self.client.get(
            f"/publications/publication/{self.voice_publication.uuid}/picture"
        )
    ...
    def test_serve_publication_audio(self):
        ...
        voice_response = self.client.get(
            f"/publications/publication/{self.voice_publication.uuid}/audio"
        )
