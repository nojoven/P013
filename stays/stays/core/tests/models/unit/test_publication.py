...
class PublicationModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.profile = baker.make(Profile,
        ...
        cls.publication = baker.make(Publication, title='Title One', author_username=cls.profile.username, author_slug=cls.profile.slug, picture='picture.jpg', voice_story='voice.mp3')
...
class PublicationModelFieldsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.text_publication = baker.make(Publication, 
        title='Text Story', 
        ...
        cls.voice_publication = baker.make(Publication, 
        title='Voice Story', 
        author_username=cls.profile.username, 
        author_slug=cls.profile.slug, 
        picture='picture.jpg', 
    ...
    def test_text_publication(self):
        ...
        self.assertEqual(self.text_publication.get_absolute_url(), reverse('users:account', args=[self.text_publication.author_slug]))
    ...
    def test_voice_publication(self):
        ...
        self.assertEqual(self.voice_publication.get_absolute_url(), reverse('users:account', args=[self.voice_publication.author_slug]))
        self.assertEqual(self.voice_publication.content_type, ContentTypes.voice.value[0])
...
class PublicationModelAllFieldsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.full_publication = baker.make(Publication, 
        title='Full Story', 
        author_username=cls.profile.username, 
        author_slug=cls.profile.slug, 
        picture='picture.jpg', 
    ...
    def test_full_publication(self):
        ...
        self.assertEqual(self.full_publication.get_absolute_url(), reverse('users:account', args=[self.full_publication.author_slug]))
        ...
        self.assertEqual(self.full_publication.created_at.date(), self.full_publication.updated_at.date())