...
class PublicationUpvoteModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.profile2 = baker.make(Profile, 
        ...
        self.full_publication = baker.make(Publication, 
        title='Full Story', 
        ...
        self.publication_upvote1 = baker.make(PublicationUpvote,
    ...
    def test_publication_second_upvote(self):
        publication_upvote2 = baker.make(PublicationUpvote,
        publication=self.full_publication,
