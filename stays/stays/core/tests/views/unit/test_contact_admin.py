...
class TestContactAdminView(TestCase):
    ...
    def test_contact_admin_form_submission_valid(self):
        ...
        self.assertEqual(response.status_code, 302)  # Redirection après la soumission réussie
    ...
    def test_contact_admin_form_submission_invalid(self):
        ...
        self.assertEqual(response.status_code, 200)  # Pas de redirection après la soumission échouée
